    ...
    protected boolean initializeCamera(int width, int height) {
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < numberOfCameras; i++) {
                ...
                int cameraFacing = mCameraIndex == CAMERA_ID_BACK ? CAMERA_FACING_BACK : CAMERA_FACING_FRONT;
    ...
    /* Now set camera parameters */
            try {
                ...
                for (int i = 1; i < sizeList.size(); i++) {
                    ...
                    if (size.width / 4 == size.height / 3 && size.height <= 1280 &&(previewSize == null || size.height > previewSize.height)) {
                        previewSize = size;
                    }
                }
                ...
                params.set("iso", "auto");
                boolean hasFlash = false;// SevenBitsDemo.getInstance().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH);
                if (hasFlash) {
                ...
                for (int[] fpsRange : params.getSupportedPreviewFpsRange()) {
                    LogUtils.d(TAG, "initializeCamera: " + Arrays.toString(fpsRange));
                }
